...
Price.create(it: "3.0", finance: "2.3", call_center: "2.0", logisticts: "2.0", marketing: "2.1", technology: "2.8", supplier_id: 1)

Price.create(it: "1.0", finance: "2.6", call_center: "2.1", logisticts: "1.5", marketing: "2.0", technology: "2.4", supplier_id: 2)

User.create(id:11, name:"petter", email:"petter.fagerlund@gmail.com", password:"123")
